...
const article = {
    ...
    img: 'https://www.tutorialbar.com/wp-content/uploads/1775636_edbd_8-2048x1152.jpg',
    views: 1022,
    ...
    user: {
        id: '1',
        username: 'Anton',
        avatar: 'https://i.redd.it/f6npt1gcjcc31.jpg',
    },
    blocks: [
        {
            id: '1',
...
isLoadingBig.args = { isLoading: true, articles: [], view: ArticleView.BIG };
